...
echo "ShadowSync reset for Linux"
echo
...
remove_path "$data_home/rad/ShadowSync"
remove_path "$config_home/ShadowSync"
remove_path "$HOME/.config/autostart/shadowsync.desktop"
remove_path "$HOME/.config/autostart/ShadowSync.desktop"
